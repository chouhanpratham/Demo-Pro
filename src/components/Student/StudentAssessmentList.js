    ...
    <div className="container py-4">
      <div className="page-header mb-4 d-flex align-items-center gap-3">
        ...
        <div>
          ...
          <p className="text-secondary mb-0">Select a course to view and take available assessments.</p>
        </div>
      </div>
      <div className="mb-4">
        <input
        ...
        <div className="assessment-list-section mt-4 p-4" style={{ background: '#f7f7fa', borderRadius: '1.2rem', boxShadow: '0 2px 12px 0 rgba(124,58,237,0.06)' }}>
          ...
          <div className="row g-4">
            {assessments.length === 0 ? (
              ...
              <div className="col-12 col-md-6 col-lg-4" key={assessment.assessmentId}>
                <div className="assessment-card p-4 h-100 d-flex flex-column justify-content-between" style={{ background: '#fff', border: '2px solid #e5e7eb', borderRadius: '1.1rem', boxShadow: '0 2px 8px 0 rgba(24,24,27,0.06)', transition: 'box-shadow 0.18s, border-color 0.18s', minHeight: 260, padding: '2.2rem 1.5rem' }}>
                  <div>
                  ...
                  <div className="mt-auto d-flex justify-content-center">
                    <Link to={`/student/take-assessment/${assessment.assessmentId}`} className="media-action-btn w-100 d-flex align-items-center justify-content-center" style={{ fontWeight: 700, color: '#7c3aed', fontSize: '1.25rem', background: 'transparent', border: 'none', boxShadow: 'none', padding: '0.75rem 0', textDecoration: 'none' }}>
                      <i className="fas fa-play-circle me-2" style={{ color: '#7c3aed', fontSize: '1.35rem' }}></i>
                      Take Assessment
                    </Link>
                  </div>
                </div>
